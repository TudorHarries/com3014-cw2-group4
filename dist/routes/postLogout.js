...
exports.postLoginRouter.post("/login", body_parser_1.default.json(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const account = yield (0, db_1.getAccount)(dbName, collectionName, body.email);
    // We should return more descriptive stuff than just false
    const result = account != undefined
        ? yield (0, bcryptjs_1.compare)(body.password, account.password)
        : false;
    res.send(result);
}));
//# sourceMappingURL=postLogout.js.map